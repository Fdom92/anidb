      ...
      <div class="anime-info-section">
        ...
        <div class="anime-info-row">
          ...
          <p class="right-section">
            {this.capitalizeFirstLetter(this.anime.format)}
          </p>
        </div>
        {this.format === "MOVIE" && (
          <div class="anime-info-row">
        ...
        {this.format !== "MOVIE" && (
          <div class="anime-info-row">
            ...
            <p class="right-section">
              {this.capitalizeFirstLetter(this.anime.status)}
            </p>
          </div>
        )}
      </div>
